...
uses
  ...
  ACBrBase, ACBrDFe, ACBrNFe, Vcl.Grids;
...
type
  TFormProcessarNFe = class(TForm)
    ...
    lblIPI: TLabel;
    lblDesconto: TLabel;
    lblFreteNaoIncluso: TLabel;
    lblValorTotalNF: TLabel;
    edtBaseICMS: TEdit;
    edtICMS: TEdit;
    edtBaseST: TEdit;
    edtST: TEdit;
...
begin
  try
    ...
    edtVersaoNFe.Text := FloatToStr(ACBrNFe.NotasFiscais.Items[0].NFe.infNFe.Versao);
    edtChaveAcesso.Text := ACBrNFe.NotasFiscais.Items[0].NFe.infNFe.ID;
    edtDV.Text :=  IntToStr(ACBrNFe.NotasFiscais.Items[0].NFe.Ide.cDV);
    edtUF.Text := IntToStr(ACBrNFe.NotasFiscais.Items[0].NFe.Ide.cUF);
    edtCodNFe.Text := IntToStr(ACBrNFe.NotasFiscais.Items[0].NFe.Ide.cNF);
    edtNaturezaOperacao.Text := ACBrNFe.NotasFiscais.Items[0].NFe.Ide.natOp;
    edtSerie.Text := IntToStr(ACBrNFe.NotasFiscais.Items[0].NFe.Ide.serie);
    edtMod.Text := IntToStr(ACBrNFe.NotasFiscais.Items[0].NFe.Ide.modelo);
    edtNumeroNF.Text := IntToStr(ACBrNFe.NotasFiscais.Items[0].NFe.Ide.nNF);
    edtDtEmissao.Text := DateToStr(ACBrNFe.NotasFiscais.Items[0].NFe.Ide.dEmi);
    edtDtEntradaSaida.Text := DateToStr(ACBrNFe.NotasFiscais.Items[0].NFe.Ide.dSaiEnt);
